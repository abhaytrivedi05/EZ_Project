...
st.markdown("""
Welcome to the Smart Research Summarization Assistant!
Easily upload a document and explore it through interactive features:

✨ Automatic Summarization – Quickly understand the core ideas.

❓ Ask Questions – Get instant answers based on the document's content.

🧠 Challenge Mode – Test your comprehension with tailored questions.
""")

# File uploader in sidebar
with st.sidebar:
    st.header("📄 Select PDF to Analyze")
    uploaded_file = st.file_uploader(
        "Upload a PDF or TXT document", 
        type=["pdf", "txt"],
        help="Upload a research paper, article, or structured English report, or similar"
    )
